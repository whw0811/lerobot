...
snapshot_download(
    ...
    repo_type="dataset",
    local_dir="/root/autodl-tmp/datasets/huggingface/lerobot/datasets/HuggingFaceVLA/libero",
...
python -m lerobot.policies.smolvla.lambda_labels \
  ...
  --root=/root/autodl-tmp/datasets/huggingface/lerobot/datasets/HuggingFaceVLA/libero \
  --output-path=/root/autodl-tmp/outputs/lerobot/outputs/lambda/libero/lambda_labels.pt \
  --checkpoint-path=/root/autodl-tmp/outputs/lerobot/outputs/lambda/libero/residual_predictor.pt \
  --epochs=20 \
  --batch-size=256 \
  --lr=1e-3 \
  --hidden-dim=256 \
  ...
  --policy.lambda_labels_path=/root/autodl-tmp/outputs/lerobot/outputs/lambda/libero/lambda_labels.pt \
  --dataset.repo_id=HuggingFaceVLA/libero \
  --dataset.root=/root/autodl-tmp/datasets/huggingface/lerobot/datasets/HuggingFaceVLA/libero \
  --batch_size=64 \
  --num_workers=8 \
  --steps=100000 \
  --save_freq=5000 \
  ...
  --wandb.enable=false \
  --eval_freq=0 \
  --output_dir=/root/autodl-tmp/outputs/lerobot/outputs/train/smolvla_init_vlm_lambda

2.3 测试
lerobot-eval \
  --output_dir=/root/autodl-tmp/outputs/lerobot/outputs/eval/smolvla_init_vlm_lambda \
  --env.type=libero \
  --env.task=libero_spatial,libero_object,libero_goal,libero_10 \
  --eval.batch_size=1 \
  --eval.n_episodes=10 \
  --policy.path=/root/autodl-tmp/outputs/lerobot/outputs/train/smolvla_init_vlm_lambda/checkpoints/last/pretrained_model \
